...
public class DroidCafeSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_droid_cafe_settings);
        setTitle(R.string.title_name_droid_cafe_settings);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DroidCafeSettings.this,
                        OrderActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_settings:
                Intent settingsIntent = new Intent(DroidCafeSettings.this,
